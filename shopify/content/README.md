...
| `guide-find-your-logical-family.html` | `guide-find-your-logical-family` | **Unlisted.** Video embedded Sep 2026. |
| `guide-building-a-comfy-college-life.html` | `guide-building-a-comfy-college-life` | **Unlisted.** Video embedded Sep 2026. |
...
| `guide-find-your-logical-family` | `gid://shopify/Page/129328578660` | video `h02HSZN7CiM` |
| `guide-building-a-comfy-college-life` | `gid://shopify/Page/129328906340` | video `qccOwkqIqz0` |
...
| `guide-find-your-logical-family` | Find Your Logical Family | `h02HSZN7CiM` |
| `guide-building-a-comfy-college-life` | Building a Comfy College Life | `qccOwkqIqz0` |
...
The dashed `.instamom-guide__video-pending` stand-in is gone from all five video
pages whose videos are embedded. Its CSS rule remains in `assets/instamom.css`
as the documented furniture for any future guide page that ships ahead of its
video.
